...
'''	
#Calculo de cinematica inversa Dennis
print(x)
print(y)

q1 = np.arctan((y)/(x+0.9))

h1 = np.sqrt(x**2+80**2)

q2 = np.arccos((310**2+h1**2-193**2)/(2*193*310))

q3 = np.arccos((193**2+310**2-h1**2)/(2*193*310))
